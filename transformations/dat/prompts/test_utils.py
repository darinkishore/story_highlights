import pytest
from transformations.dat.prompts.prompt_templates import characters, plot_elements, descriptions
from transformations.dat.prompts.utils import get_best_story_for_category
...
@pytest.mark.parametrize("category", [characters, plot_elements, descriptions])
def test_best_story_for_category(category, reference_stories):
    best_story = get_best_story_for_category(category, reference_stories)
